...
```text
GCW制造几何/中心线 ─┐
                     ├─> 版本化产物 ─> physics-engine物理 ─> WDS只读消费
WII模型/运动时间线 ─┘
```

GCW/WII仍拥有B-Rep、中心线生产、机器人IK/FK、路径和模型发布；本仓拥有模型物理角色、
杆/带材、接触、输运、张力、测量、求解与案例。WDS不得反向改写GCW/WII，也不复制公共物理。
完整证据与实施路线见[research/19](research/19_绕制偏差物理基础设施与上游模型接入调研_20260820.md)、
[0096](decisions/0096_绕制偏差物理基础设施归本仓与WDS单向消费边界_20260820.md)和
